...
from app.repositories.transaction_repository import create_transaction as save_transaction , get_transactions_by_symbol as get_transactions_by_symbol_repository,get_transactions_by_user_id
...
async def get_transactions_by_symbol(symbol,user):
    return await get_transactions_by_symbol_repository(symbol,user["id"])